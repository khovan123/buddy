...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-6 overflow-hidden rounded-lg border border-border/70 bg-card/74 py-6 text-sm text-card-foreground shadow-[0_18px_42px_-32px_color-mix(in_oklch,var(--education-ink)_40%,transparent)] ring-1 ring-white/5 backdrop-blur-xl has-[>img:first-child]:pt-0 data-[size=sm]:gap-4 data-[size=sm]:py-4 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg",
        className
      )}
      {...props}
    />
